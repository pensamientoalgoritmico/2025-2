...
let frasesPorTitulo = {
  ...
  "Retratos Entre Paraguas": "Sombras y colores\n se cruzan bajo\n la lluvia compartida",
  "Ecos De Ladrillos": "Las paredes susurran\n historias que nunca\n se derrumban",
  "Archivo Melancólico": "Cada hoja guarda un\n recuerdo que se \nniega a desaparecer",
  "Bitácora De La Lluvia": "Las gotas escriben\n diarios invisibles\n sobre la ciudad",
  "Atlas Sentimental": "Un mapa de emociones\n que guía\ncorazones perdidos",
  "Generador De Nostalgias": "Cada instante revive\n lo que\n parecía olvidado",
  "Memorias En Loop": "El pasado regresa\n como un \neco interminable",
  "Entre Tinto & Lluvia": "El café caliente\n acompaña las tardes mojadas \nde la ciudad",
...
function mousePressed() {
  ...
  if (mouseX > posx && mouseX < posx + 250 &&
      mouseY > yinicio - 100 && mouseY < yinicio - 80) {
    focusCampo = "de";
  }
  else if (mouseX > posx + 13 && mouseX < posx + 250 &&
      mouseY > yinicio - 80 && mouseY < yinicio - 50) {
    focusCampo = "para";
  }
...
rect(12, 0, 22, 50, 3);  
 ...
 rect(8, 5, 12, 12, 2);
  ...
  let mangoColor = color(detalles[0] - 40, detalles[1] - 40, detalles[2] - 40);
